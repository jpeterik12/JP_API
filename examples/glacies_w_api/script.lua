...
CARDS={
	...
	{ gid=52, n=1, id="Golden Aging",				need={4,8}, delay=10, cycle=1, delayed={queen_tempo=1,leader_tempo=1}	},
...
PIECES={
	...
	{type=1, name="knight", 	hp=3, tempo=3, danger=3, seek="kdist" },
	{type=2, name="bishop", 	hp=4, tempo=3, danger=3, seek="bdist" },
	{type=3, name="rook", 		hp=5, tempo=4, danger=6, seek="rdist" },	
	{type=4, name="queen", 		hp=5, tempo=4, danger=9, seek="qdist" },
	{type=5, name="king", 		hp=8, tempo=4, danger=6, seek="wdist" },
	{type=6, name="boss", 		hp=24, tempo=3, danger=16, big=true, seek="wdist" }, 
	{type=7, name="all", 		 	}, 
	{type=8, name="leader", 	},
